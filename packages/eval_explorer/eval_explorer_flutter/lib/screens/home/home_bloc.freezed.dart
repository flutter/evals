...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( InitializeHome value)?  init,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( InitializeHome value)  init,}){
final _that = this;
switch (_that) {
case InitializeHome():
return init(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( InitializeHome value)?  init,}){
final _that = this;
switch (_that) {
case InitializeHome() when init != null:
return init(_that);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.profile, profile) || other.profile == profile));
}
...
@override
String toString() {
  return 'HomeState(profile: $profile)';
}
...
class _HomeState extends HomeState {
  const _HomeState({required this.profile}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeState&&(identical(other.profile, profile) || other.profile == profile));
}
